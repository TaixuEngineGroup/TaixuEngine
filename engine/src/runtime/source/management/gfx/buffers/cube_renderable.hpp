...
private:
    ...
    static constexpr std::array<GLfloat, CUBE_VERTEX_COUNT> CUBE_VERTICES = {                    //   Coordinates
                                                                             -1.0f, -1.0f, 1.0f, //        7--------6
                                                                             1.0f,  -1.0f, 1.0f, //       /|       /|
                                                                             1.0f,  -1.0f, -1.0f,//      4--------5 |
                                                                             -1.0f, -1.0f, -1.0f,//      | |      | |
    ...
    static constexpr std::array<std::uint32_t, CUBE_ELEMENT_COUNT> CUBE_ELEMENTS = {// Right
                                                                                    1, 2, 6, 6, 5, 1,
                                                                                    // Left
                                                                                    0, 4, 7, 7, 3, 0,
                                                                                    // Top
